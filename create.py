...
class Account:
    ...
    def send_code(
        ...
        response = self.session.post(
            url     = "https://api16-normal-c-useast1a.tiktokv.com/passport/email/send_code/",
    ...
    def verify_code(
        ...
        response = self.session.post(
            url     = "https://api16-normal-c-useast1a.tiktokv.com /passport/email/register_verify_login/",
            params  = self.base_params(),
